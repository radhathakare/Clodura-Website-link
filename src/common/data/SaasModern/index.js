...
export const MENU_ITEMS = [
  // {
  //   label: "Platform",
  //   path: "/sales-prospecting-platform/",
  //   offset: "0"
  // },
  {
    label: "Product",
  ...
  {
    label: "Login",
    path: "https://app.clodura.ai/#/auth/login/",
    offset: "0"
  }
];
export const RESOURCE_ITEMS = [
  ...
  {
    label: "Sales Street Videos",
    path: "/salesstreetvideos/",
    offset: "0"
  },
  {
    label: "Videos",
  ...
  {
    label: "Tutorials",
    path: "/clodura-ai-product-tutorials/",
    offset: "0"
  }
];
export const PRODUCT_ITEMS = [
  {
    label: "B2B Data Lists",
    path: "/b2b-data-lists/",
    offset: "0"
  },
  {
  ...
  {
    label: "Technology Install Base Data",
    path: "/technology-install-base-data/",
    offset: "0"
  },
  {
...
export const COMPANY_ITEMS = [
  {
    label: "Customers",
    path: "/our-happy-customers-clodura-ai/",
    offset: "0"
  },
  {
    label: "Executives",
...
export const MENU_ITEMSINDEP = [

  {
    label: "About Us",
    path: "https://www.clodura.ai/",
    offset: "0"
  },
  {
    label: "Login",
  ...
  {
    label: "FREE SIGN UP",
    path: "https://app.clodura.ai/#/auth/register/",
    offset: "0"
  }
];
