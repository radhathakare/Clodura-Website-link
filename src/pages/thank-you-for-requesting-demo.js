...
import BannerSection from 'containers/Custom/Thankyoupage/BannerTHReq';
...
const Thankyoupage = () => {
  ...
  return (
    <ThemeProvider theme={saasModernTheme}>
      <Fragment>
        <Seo title="Thank you for booking a demo of our AI-Powered B2b Lead Generation Platform." description="We appriciate your interest in our AI-powered B2B Lead Gen, B2B Contact Data and Sales Intelligence platform. We recommend you to go through our free database and latest blogs till demo start." robots="noindex, follow" canonical="https://www.clodura.ai/thank-you-for-requesting-demo/" />
        <ResetCSS />
