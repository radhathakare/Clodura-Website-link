      ...
      <Container>
        <Box {...row} {...textAreaRow}>
          <Box {...col} {...textArea}>
            <Heading
              {...title}
              content="aaaManual Process: Daunting Challenge of Time and Accuracy."
            />
            <Text
              {...description}
              content="Generating leads through the age-old manual process? We know it takes time to create a precise and qualified list of leads. Make your sales team smarter, and help them generate highly accurate, relevant and qualified leads in no time with Clodura's AI powered, next-gen automated lead gen platform."
            />
            <Box>
              <a href="#1">
...
InfoSection.defaultProps = {
  ...
  title: {
    fontSize: ['22px', '28px', '32px', '36px', '44px'],
    fontWeight: '600',
    color: '#0f2137',
