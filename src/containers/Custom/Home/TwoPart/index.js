...
const TwoPart = () => {
    ...
    return (
        <TwoPartWrapper>
            <TwoPartHeader>
                <Heading as="h3" content="Manual Process" style={{ borderBottom: `${tab === 0 ? '4px solid #03BAED' : 'none'}`, color: `${tab === 0 ? '#03BAED' : 'black'}` }} onClick={() => setTab(0)} />
                <Heading as="h3" content="Multiple Tool Usage" style={{ borderBottom: `${tab === 1 ? '4px solid #03BAED' : 'none'}`, color: `${tab === 1 ? '#03BAED' : 'black'}` }} onClick={() => setTab(1)} />
            </TwoPartHeader>
